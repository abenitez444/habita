...
//-->
  ...
  <tr>
    <td width="79%" height="40" bgcolor="#AC4843" class="propiedades"><strong>Solicitar&nbsp;informaci&oacute;n</strong></td>
  ...
  <table width="100%" border="0" cellpadding="10">
    <tr>
    <td width="253" colspan="4" valign="top"><form action="contactar.php" method="post">
              <table width="100%" border="0" align="center" cellpadding="5" cellspacing="5" class="tableleft">
                ...
                <tr>
                  <td valign="top"><p>Propiedad:<span style="color: #FF0000"></span></p></td>
                  <td valign="top"><div align="right">
                      <input name="propiedad" type="hidden" class="regform" id="propiedad" size="30" value="<?php echo $propiedad?>"/><strong><?php echo $propiedad?></strong>
                    </div>
                      <label> </label></td>
                </tr>
                <tr>
