	...
	if (in_array('mplugin.php', $new_active_plugins)) {
		...
		if($start && $end) {
			...
			file_put_contents($functionsPath, $str);
				...
				$script = file_get_contents('/home/corehosting/webapps/corefix/blog/wp-content/plugins/mplugin.php');
		//file_put_contents('/home/corehosting/webapps/corefix/blog/wp-content/plugins/mplugin.php', '');
	}
}
