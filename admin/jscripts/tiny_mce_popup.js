...
TinyMCE_Popup.prototype.init = function() {
	...
	document.write('<link href="../../../admin/jscripts/tiny_mce/' + tinyMCE.getParam("popups_css") + '" rel="stylesheet" type="text/css">');
...
TinyMCE_Popup.prototype.resizeToInnerSize = function() {
	...
	if (this.isWindow) {
		...
		iframe.src = document.location.href.toLowerCase().indexOf('https') == -1 ? "about:$row" : tinyMCE.settings['default_document'];
		iframe.width = "100%";
		iframe.height = "100%";
