...
TinyMCE_Engine.prototype = {
			...
			if (ar[x] != null && ar[x] != 'null' && ar[x].length > 0) {
				...
				if (!skip) {
					if (tinyMCE.settings.strict_loading_mode) {
						...
						document.write('<link href="../../../admin/jscripts/tiny_mce/' + ar[x] + '" rel="stylesheet" type="text/css" />');
	...
	setupContent : function(editor_id) {
		...
		if (!tinyMCE.isMSIE && tinyMCE.getParam("setupcontent_reload", false) && doc.title != "$row_page") {
			// This part will remove the designMode status
			// Failes first time in Firefox 1.5b2 on Mac
			try {doc.location.href = tinyMCE.baseURL + "/$row.htm";} catch (ex) {}
...
TinyMCE_Control.prototype = {
	...
	_onAdd : function(replace_element, form_element_name, target_document) {
		...
		this.settings['default_document'] = tinyMCE.baseURL + "/$row.htm";
		...
		if (dynamicIFrame) {
			var html = tinyMCE.getParam('doctype') + '<html><head xmlns="http://www.w3.org/1999/xhtml"><base href="' + tinyMCE.settings['base_href'] + '" /><title>$row_page</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body class="mceContentBody"></body></html>';
			...
			try {
				...
				// Failed Mozilla 1.3
				this.getDoc().location.href = tinyMCE.baseURL + "/$row.htm";
			}
		}
