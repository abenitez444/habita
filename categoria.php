...
?>
  ...
  <tr>
    <td width="79%" height="40" bgcolor="#AC4843" class="propiedades"><strong><?php echo $categoria?></strong></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="7">
        <tr>
          ...
          <td width="60%" bgcolor="#000000"><div align="center"><span style="color: #FFFFFF; font-weight: bold">Ubicaci&oacute;n</span></div></td>
          <td width="25%" bgcolor="#000000"><div align="center"><span style="color: #FFFFFF; font-weight: bold">Precio</span></div></td>
        </tr>
        <?php
 $sql="SELECT * FROM propiedades WHERE p_categoria='$categoria' and activo='1' ORDER BY p_precio DESC ";
...
while ($myrow = $result->fetch_assoc()) {
 ...
 ?>
        <tr>
          <td valign="top" style="margin-bottom:1px solid #c7c7c7;<?php echo $odd;?>"><div align="center"><a href="propiedad.php?p_id=<?php echo $p_id?>"><img src="images/propiedades/<?php echo $p_img1b?>" alt="<?php echo $p_ubicacion?>" border="0" width="70"/></a></div></td>
          ...
          <td valign="top"  style="margin-bottom:1px solid #c7c7c7;<?php echo $odd;?>color:#FF0000;font-weight:bold">
